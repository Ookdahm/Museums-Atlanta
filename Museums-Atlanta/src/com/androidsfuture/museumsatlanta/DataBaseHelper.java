...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.androidsfuture.museumsatlanta/databases/";
    private static String DB_NAME = "museumsAtlanta03";
	...
	//Map query details
	private static String[] FROM_MAPS = {KEY_ROWID_01, KEY_LAT, KEY_LONG, KEY_MUSEUM, KEY_ADDRESS, KEY_OPEN};
  ...
  /**
	...
	/*
	 *  We find the longitude and latitude coordinates to populate the map
	 */
	
	public Cursor mapLocation(){
		
		return myDataBase.query(TABLE_NAME, FROM_MAPS, null, null, null, null, null);
